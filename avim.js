...
var AVIMGlobalConfig = {
	...
	exclude: ["email","cpassword","urepassword","txtCode","txtEnContent","authCode","txtInviteFriend","searchSecCode_search"], //IDs of the fields you DON'T want to let users type Vietnamese in
...
//		document.write('<div id="AVIMControl" name="AVIMControl" style="width:400px;position:fixed; bottom:0px; right:0px;">');
//        document.write('<input id="avim_auto" type="radio" name="AVIMMethod" onclick="document.getElementById(\'btnShowHideInput\').value=\'Input(Auto)\';AVIMObj.setMethod(0);" />Auto');
//        document.write('<input id="avim_telex" type="radio" name="AVIMMethod" onclick="document.getElementById(\'btnShowHideInput\').value=\'Input(Telex)\';AVIMObj.setMethod(1);" />TELEX');
//        document.write('<input id="avim_vni" type="radio" name="AVIMMethod" onclick="document.getElementById(\'btnShowHideInput\').value=\'Input(VNI)\';AVIMObj.setMethod(2);" />VNI');
//        document.write('<input id="avim_viqr" type="radio" name="AVIMMethod" onclick="document.getElementById(\'btnShowHideInput\').value=\'Input(VIQR)\';AVIMObj.setMethod(3);" />VIQR');
//        document.write('<input id="avim_viqr2" type="radio" name="AVIMMethod" onclick="document.getElementById(\'btnShowHideInput\').value=\'Input(VIQR*)\';AVIMObj.setMethod(4);" />VIQR*');
//        document.write('<input id="avim_off" type="radio" name="AVIMMethod" onclick="document.getElementById(\'btnShowHideInput\').value=\'Input(Off)\';AVIMObj.setMethod(-1);" />OFF');
//        document.write('<input name="button" type="button" id="button" onclick="document.getElementById(\'AVIMControl\').style.display=\'none\';document.getElementById(\'divInput\').style.display=\'block\';" value="Input" align="middle" />');
//        document.write('</div>');

//        document.write('<div id="divInput" style="width:55px;position:fixed; bottom:0px; right:0px;">');
//        document.write('<input type="button" id="btnShowHideInput" name="btnShowHideInput" align="middle" value="Input(Auto)" onclick="divInput_OnClick();" />');
//        document.write('</div>');
	}
	...
	this.doSetCookie = function() {
		...
		document.cookie = 'AVIM_on_off=' + AVIMGlobalConfig.onOff + ';expires=' + exp+"; path=/";
		document.cookie = 'AVIM_method=' + AVIMGlobalConfig.method + ';expires=' + exp+"; path=/";
		var method_name;
		switch(AVIMGlobalConfig.method)
		{
		    case 0: {method_name="Tự động";break;}
		    case 1: {method_name="Telex";break;}
		    case 2: {method_name="VNI";break;}
		    case 3: {method_name="VIQR";break;}
		    case 4: {method_name="VIQR*";break;}
		    case -1: {method_name="Tắt";break;}
		}
		method_name = encodeURIComponent(method_name);
		document.cookie = 'AVIM_method_name=' + method_name + ';expires=' + exp+"; path=/";
		document.cookie = 'AVIM_ckspell=' + AVIMGlobalConfig.ckSpell + ';expires=' + exp+"; path=/";
		document.cookie = 'AVIM_daucu=' + AVIMGlobalConfig.oldAccent + ';expires=' + exp+"; path=/";
	}
...
//window.onscroll = funcInputPos;

//function funcInputPos()
//{
//    var targetInput = document.getElementById("divInput");
//    var targetBar = document.getElementById("AVIMControl");
//    if(!document.all)
//    { // firefox
//        targetInput.style.left = core.getInsideWindowWidth()-110;   
//        targetInput.style.top  = document.body.scrollTop + core.getInsideWindowHeight()-25;  
//        targetBar.style.left = core.getInsideWindowWidth()-core.getObjectWidth("AVIMControl")-20;   
//        targetBar.style.top  = document.body.scrollTop + core.getInsideWindowHeight()-25;
//    }
//    else
//    { // ie             
//        targetInput.style.left = core.getInsideWindowWidth()-110;   
//        targetInput.style.top  = document.body.scrollTop + core.getInsideWindowHeight()-25;  
//        targetBar.style.left = core.getInsideWindowWidth()-core.getObjectWidth("AVIMControl");   
//        targetBar.style.top  = document.body.scrollTop + core.getInsideWindowHeight()-25;
//    }
//}
//function divInput_OnClick()
//{
//    core.getObject("AVIMControl").style.display="block";
//    core.getObject("divInput").style.display="none";
//}